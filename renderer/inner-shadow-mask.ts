...
export function gooseBuildInnerShadowPath(
  w: number,
  h: number,
  radius: number,
  useG2: boolean
...
export interface GooseInnerShadowMaskParams {
...
export function gooseGenerateInnerShadowMask(params: GooseInnerShadowMaskParams): GooseInnerShadowMaskResult {
