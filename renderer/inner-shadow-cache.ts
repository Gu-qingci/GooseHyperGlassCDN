...
export function gooseBuildInnerShadowMaskKey(shadowIndex: number, params: GooseInnerShadowMaskParams): string {
  return [
    'is',
    shadowIndex,
    params.useG2 ? 'g2' : 'rr',
...
export function gooseGetOrCreateMaskEntry(
  cache: Map<string, GooseInnerShadowCacheEntry>,
  gl: WebGLRenderingContext,
  key: string,
  maskW: number,
  maskH: number
): GooseInnerShadowCacheEntry {
...
export function gooseUploadMaskTexture(
  gl: WebGLRenderingContext,
  entry: GooseInnerShadowCacheEntry,
  result: GooseInnerShadowMaskResult
): void {
...
export function gooseDestroyInnerShadowCache(
  gl: WebGLRenderingContext,
  cache: Map<string, GooseInnerShadowCacheEntry>
): void {
